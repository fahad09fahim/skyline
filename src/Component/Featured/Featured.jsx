    ...
    <div className="p-24">
      ...
      <div className='grid grid-cols-3 gap-3 my-6'>
        ...
        <div className='p-8 bg-slate-200 rounded-lg'> 
           ...
           <h1 className='text-xl font-medium'>Seaside Serenity Villa</h1>
        ...
        <div className='p-8 bg-slate-200 rounded-lg'>
           ...
           <h1 className='text-xl font-medium'>Metropolitan Haven</h1>
        ...
        <div className='p-8 bg-slate-200 rounded-lg'>
           ...
           <h1 className='text-xl font-medium'>Rustic Retreat Cottage</h1>
